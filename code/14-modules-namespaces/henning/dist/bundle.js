...
define("components/project-list", ["require", "exports", "models/project", "components/base-component", "components/project-item", "decorators/autobind", "state/project-state"], function (require, exports, project_js_2, base_component_js_3, project_item_js_1, autobind_js_3, project_state_js_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ProjectList extends base_component_js_3.Component {
        ...
        renderProjects() {
            ...
            for (const projItem of this.assignedProjects) {
                ...
                new project_item_js_1.ProjectItem(hostElement.id, projItem);
            }
        }
        configure() {
